...
public enum CommandValidationType
{
  ...
  InMode = 1, // (int mode)
  /// <summary>
  /// Checks if the command is in the given line cmd.
  /// </summary>
  InLineCmd = 2, // (int linecmd_type)
  /// <summary>
  /// Checks if the command is of the given type.
  /// </summary>
  IsCommandType = 3, // (int cmd_type)
  /// <summary>
  /// Checks if the command letter matches the given letter.
  /// </summary>
  IsCommandLetter = 4, // (string cmd_letter)
  /// <summary>
  /// Indicates whether a specific field is defined.
  /// </summary>
  HasFieldDefined = 5, // ()
  /// <summary>
  ...
  /// <summary>
  /// Value is within the specified set.
  /// </summary>
  ValueWithinSet = 7, // (int index, object[] set)
  /// <summary>
  /// Has a data value at the specified index.
  /// </summary>
  HasValueIndex = 8, // (int index)
  /// <summary>
  /// Checks that there are no duplicate values at the specified field index.
  /// </summary>
