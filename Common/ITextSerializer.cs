...
{
  /// <summary>Creates a lossless representation of the calling object.</summary>
...
/// <summary>An object that retains a reference to the object it was created from.</summary>
public interface IRetainOrigin
{
  object Origin { get; }

  /// <summary>Attempts to save a reference to a given object.</summary>
...
{
  /// <summary>Gets a typed reference to the origin object.</summary>
