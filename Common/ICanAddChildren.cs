...
/// <summary>An interface that indicates that an object contains children.</summary>
/// <typeparam name="TChild">The type of child that this object contains.</typeparam>
public interface ICanAddChildren<in TChild>
{
  ...
  /// <summary>Adds multiple children.</summary>
