...
public static class Definition
{
  ...
  public static Spec ACS => new()
  {
    ...
    TokenCompatLookup = {
      ...
      [AT.FuncStmt] = [AT.VarDecl, AT.BasicCmd, AT.FunctionCallStmt, AT.VarAssn, AT.VarInc, AT.ArrayDecl, AT.VarDeclAssn],
    ...
    GroupTokenRules = [
      ...
      new(RT.None, AT.PreprocessorFull,            "x:Pre ti:Preprocessor{Define|LibDefine} n:DefineName v:Value"),
      new(RT.None, AT.PreprocessorFull,            "x:Pre ti:Preprocessor{Import|Library|Include} v:Str"),
      ...
      // Function Accepted
      new(RT.None, AT.IfBlock,                     "t:If x:Po v:Value x:Pc x:Bo pa:(FuncStmt|Stmt) x:Bc"),
      new(RT.None, AT.IfBlock,                     "t:If x:Po v:Value x:Pc p:(FuncStmt|Stmt)"),
      new(RT.None, AT.LoopBlock,                   "t:Loop x:Po v:Value x:Pc x:Bo pa:(FuncStmt|Stmt) x:Bc"),
      new(RT.None, AT.LoopBlock,                   "t:Loop x:Po v:Value x:Pc p:(FuncStmt|Stmt)"),
      new(RT.None, AT.ElseBlock,                   "t:Else x:Bo pa:(FuncStmt|Stmt) x:Bc"),
      new(RT.None, AT.ElseBlock,                   "t:Else p:FuncStmt"),
      new(RT.None, AT.ElseIfBlock,                 "t:Else x:If x:Po v:Value x:Pc x:Bo pa:(FuncStmt|Stmt|Block) x:Bc"),
      new(RT.None, AT.ElseIfBlock,                 "t:Else x:If x:Po v:Value x:Pc p:(FuncStmt|Stmt|Block)"),
      new(RT.None, AT.SwitchBlock,                 "t:Switch x:Po v:Value x:Pc x:Bo sa:(CaseLabel|FuncStmt|Stmt|Block) x:Bc"),
