...
global using AT = Specification.ZDoom.ACSTokenType;
global using MdlT = Specification.ZDoom.ModelDefTokenType;
global using MT = Specification.ZDoom.MapInfoTokenType;
global using RT = Parser.Tokens.TokenRuleType;
global using SndIT = Specification.ZDoom.SndInfoTokenType;
global using SS = System.Diagnostics.CodeAnalysis.StringSyntaxAttribute;
global using UT = Specification.ZDoom.UDMFTokenType;
global using ZT = Specification.ZDoom.ZScriptTokenType;
