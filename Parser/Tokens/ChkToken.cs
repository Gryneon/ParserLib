...
public class ChkToken : IEquatable<IToken>
{
...
/// </list>
/// </remarks>
public class ChkToken<T> (string data_string) : ChkToken(data_string), IEquatable<IToken<T>> where T : struct
{
  public new Collection<T> AllowedTypes { get; init; } = [];
