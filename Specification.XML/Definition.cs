...
public static class Definition
{
  ...
  public static Spec Spec => new()
  {
    ...
    GroupTokenRules = [
      ...
      new (BuildProperty, XTT.AttributeWithNamespace, "ty:Namespace x:Co n:AttrKey x:Eq v:String"),
      ...
      new (BuildObject, XTT.ElementSingleWithNamespace, "x:Ao ty:Namespace x:Co n:ElementName pa:Attribute x:Sl x:Ac"),
      new (BuildObject, XTT.ElementSingle, "x:Ao n:ElementName pa:Attribute x:Sl x:Ac"),
      new (BuildObject, XTT.ElementStartWithNamespace, "x:Ao ty:Namespace x:Co n:ElementName pa:Attribute x:Ac"),
