...
public static class Definition
{
  ...
  public static Spec ACS => new()
  {
    ...
    GroupTokenRules = [
      ...
      new(RT.BuildExpression | RT.Recursive, Expression,  "l:Value t:Binary r:Value"),
      new(RT.BuildExpression, ExpressionStatement,        "l:Value t:IncDec"),
      new(RT.BuildExpression, ExpressionStatement,        "t:IncDec r:Value"),
      new(RT.BuildExpression | RT.Recursive, Expression,  "l:Value t:(Binary|Minus) r:Value"),
      new(RT.BuildExpression, Expression,                 "t:(Unary|Minus) r:Value"),
      new(RT.BuildTypedValue, Expression,                 "x:Po v:Expression x:Pc"),
      new(RT.BuildStatement, FunctionCall,                "n:Name x:Po po:Value x:Pc"),
      ...
      // Statements
      new(RT.BuildStatement, VarDecl,                     "t:Type n:Name x:Sc"),
      new(RT.BuildStatement, VarDeclAssn,                 "t:Type n:Name x:Eq v:Value x:Sc"),
      new(RT.BuildStatement, ArrayDecl,                   "t:Type n:Name x:Ao v:Value x:Ac x:Sc"),
      new(RT.BuildStatement, ArrayDecl,                   "t:Type n:Name x:Ao l:Value x:Ac x:Ao r:Value x:Ac x:Sc"),
      ...
      new(RT.BuildStatement, WaitCall,                    "t:Wait x:Po p:ParameterValue x:Pc x:Sc"),
      new(RT.BuildStatement, FunctionCallStatement,       "d:FunctionCall x:Sc"),
      new(RT.BuildStatement, Case,       "d:FunctionCall x:Sc"),

      new(RT.BuildStatement, Parameter,                   "t:Type n:Name x:Cm"),
      new(RT.BuildObject, PrintParameterValue,            "n:Name{s|i} x:Co pa:Value xo:Cm"),
      new(RT.BuildTypedValue, ParameterValue,             "v:Value x:Cm"),
      new(RT.BuildStatement, PrintFunction,               "n:name x:Po p:PrintParameterValue x:Pc xSc"),

      new(RT.BuildStatement, FunctionHeader,              "x:Function t:(Type|Void) n:Name x:Po x:Void x:Pc"),
      new(RT.BuildStatement, FunctionHeader,              "x:Function t:(Type|Void) n:Name x:Po pm:Parameter x:Pc"),
      new(RT.BuildStatement, FunctionFull,                "d:FunctionHeader x:Bo s:(Statement|Block) x:Bc"),

      new(RT.BuildStatement, ScriptHeader,                "x:Script n:Value t:ScriptType x:Po p:Parameter x:Pc"),

      new(RT.BuildStatement, ScriptHeader,                "x:Script n:Value t:ScriptType"),
